...
# СВІТЛО⚡БЕЗПЕКА (v1.4.12 Autonomous Edition)
...
- **Telegram Notifications:** Оновлено формат статистики — тепер замість «Точність: +90 хв» відображається зрозуміле «Вимкнули пізніше на 1 год 30 хв».
- **Наповненість сповіщень:** Збільшено ліміт аналізу відхилень до 3 годин.
- **Точність даних:** Розрахунок базується на фактичному часі події.
