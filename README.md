...
#### **v1.14.5** (2026-03-07)
- **Документація:** Очищено README файли від надлишкового списку старих змін у верхній частині для покращення читабельності.

#### **v1.14.4** (2026-03-07)
- **Інтерфейс:** Оновлено фавікон та PWA-іконки дашборду на новий логотип Light-Safety-logo-2.

#### **v1.14.3** (2026-03-07)
- **Інтерфейс:** Оновлено фавікон та PWA-іконки дашборду на новий логотип Light-Safety-logo.
