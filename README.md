...
# СВІТЛО⚡БЕЗПЕКА (v1.7.0 Autonomous Edition)
...
- **Telegram:** Новий компактний формат повідомлень про зміну статусу з розрахунком часу до наступної планової події за графіком (наприклад, «Вимкнення через ~ 3 г 25 хв»).
- **UI/UX Web:** Оновлений дизайн блоку графіку на дашборді — тепер він розділений на дві колонки (Увімкнення та Вимкнення) для кращої читаємості.
- **Colors:** Нова кольорова схема графіку: **Teal** для періодів зі світлом та **Rose** для відключень.
- **UI/UX Logic:** Прибрано зайві заголовки, статус тривоги тепер лаконічно відображає: «Київ. Тривоги немає».
- **Time Formatting:** Виправлено відображення часу закінчення доби — тепер замість «завтра о 00:00» всюди використовується «24:00».
