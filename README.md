...
# СВІТЛО⚡БЕЗПЕКА (v1.6.0 Autonomous Edition)
...
- **UI/UX:** Новий дизайн текстових графіків у Telegram (Glassmorphism, tabular-nums).
- **Reports:** Покращено логіку генерації щоденних звітів, додано назви місяців.
- **Air Quality:** Додано гнучке налаштування станцій моніторингу повітря у config.json.
- **UI/UX Logic:** Виправлено відображення статусу на дашборді — тепер статистика точно відповідає поточному стану («Увімкнули» при світлі, «Вимкнули» при відключенні).
- **Accuracy Algorithm:** Покращено пошук найближчих планових подій для точного розрахунку відхилень.
- **Telegram Notifications:** Формат статистики тепер строго відповідає: «Вимкнули/Увімкнули пізніше/раніше на Х год Y хв».
