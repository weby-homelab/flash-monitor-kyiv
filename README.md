...
- **48/48 Logic:** Система автоматично переходить у "режим спокою", якщо графіки відключень відсутні протягом 48 годин. Це дозволяє уникнути зайвого шуму в Telegram, коли ситуація в енергосистемі стабільна.
- **Confirmation Safety Net:** Якщо світло зникне під час режиму спокою, система не відправить сповіщення миттєво, а зачекає на підтвердження (другий імпульс або ручне втручання), щоб уникнути хибних тривог від нестабільних IoT-сенсорів.
- **Автовихід:** Режим спокою автоматично вимикається, як тільки ДТЕК публікує нові графіки або фіксується перше реальне відключення.
