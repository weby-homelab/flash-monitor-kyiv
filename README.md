...
# СВІТЛО⚡БЕЗПЕКА (v1.9.7 Autonomous Edition)
...
- **Dashboard:** Додано відображення графіка на наступну добу (якщо він доступний) з автоматичним розділенням днів.
- **UI/UX:** Виправлено помилку з відображенням часу оновлення у футері дашборду.
- **Sources:** Назву джерела "Github" змінено на офіційну "ДТЕК" для кращої відповідності даним.
- **Charts:** Покращено візуальне розділення "Плану" та "Факту" на графіках (використання Indigo/Slate для плану та Teal/Rose для факту).
- **Telegram:** Повернено стабільну логіку текстових звітів з ідеальним вирівнюванням та об'єднанням джерел.
- **Time Formatting:** Виправлено відображення годин у підсумках (використовується "год").
- **Accuracy Algorithm:** Покращено пошук найближчих планових подій для точного розрахунку відхилень.
