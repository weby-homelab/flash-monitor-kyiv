...
# СВІТЛО⚡БЕЗПЕКА (v1.4.13 Autonomous Edition)
...
- **UI/UX Fix:** Усунено дублювання слів «Увімкнули/Вимкнули» у статусних повідомленнях та на дашборді.
- **Telegram Notifications:** Оновлено формат статистики — тепер відображається лаконічне «Вимкнули пізніше на 1 год 30 хв».
