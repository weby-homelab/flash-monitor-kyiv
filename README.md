...
- **48/24 Logic:** Система автоматично переходить у "режим спокою", якщо останні 48 годин не було фактичних відключень, і в найближчі 24 години за графіком їх теж не планується. Це дозволяє уникнути зайвого шуму в Telegram, коли ситуація в енергосистемі стабільна.
