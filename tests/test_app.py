...
with patch('bootstrap.perform_cold_start_if_needed'):
    import app
...
@patch('app.state')
@patch('app.secrets.compare_digest', return_value=True)
...
@patch('app.state')
@patch('app.secrets.compare_digest', return_value=False)
