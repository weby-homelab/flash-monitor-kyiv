...
# At 19:29, we received an event: "Світло з'явилося" (is_up=True)
# The system now wants to tell us when to expect the NEXT OUTAGE
# look_for_light = False
res = get_next_scheduled_event(event_time, look_for_light=False)
print("Looking for next OUTAGE (False) at 19:29:", res)
